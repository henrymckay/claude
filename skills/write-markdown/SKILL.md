...
A top-level bullet's continuation sentences sit flush at the left margin — a lazy continuation the renderer folds back in, no indent needed.
Keep a nested or numbered item's continuations indented under its text, since a flush line there would read as leaving the item.
